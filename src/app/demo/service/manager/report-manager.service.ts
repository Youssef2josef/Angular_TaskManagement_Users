...
export class ReportManagerService {
  ...
  reportUrl: string="http://localhost:8050/api/manager/report";
  ...
  downloadRapport(id: any, report: any): void {
    ...
    const creationDate = new Date(report.dateCreation); // Obtient la date de création au format AAAA-MM-JJ
